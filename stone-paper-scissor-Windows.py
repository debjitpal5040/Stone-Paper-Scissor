...
button1 = Button(window, text="Stone", bg="orange", command=stone, height=1, width=6, font=('arial', 15, 'bold')).grid(column=14, row=2)
button2 = Button(window, text="Paper", bg="pink", command=paper, height=1, width=6, font=('arial', 15, 'bold')).grid(column=15, row=2)
button3 = Button(window, text="Scissor", bg="powder blue", command=scissor, height=1, width=6, font=('arial', 15, 'bold')).grid(column=16, row=2)
